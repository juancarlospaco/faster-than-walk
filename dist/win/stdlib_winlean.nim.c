...
=======
tyProc__uryidYWkntM7ddjZSyxvyQ Dl_13278558_;
tyProc__lLim4ugM6CVjiaTaa7eXVA Dl_13277456_;
tyProc__aO673xGTLLxou7P7GxoCXA Dl_13276835_;
tyProc__im9buRnIvptJfzdASYMEbBA Dl_13277001_;
tyProc__9bXer9a4ps9aSGctILcxWReVw Dl_13276830_;
tyProc__jwEWAkul5J6p6K0UfXa1tw Dl_13277461_;
tyProc__ofoySXaAAlxxs9bQS9a1etlg Dl_13277614_;
N_LIB_PRIVATE N_NIMCALL(void, stdlib_winleanInit000)(void) {
{
	ws2__hGspZUrVrEMpO9aP9c3dJQPQ = loadLib__Yq5XYz2ycX5V5B9bUM4Uyiw(((NimStringDesc*) &TM__k6kyf4Co79a84IkK9blFuQVA_2), NIM_FALSE);
	{
...
=======
	Dl_13278558_ = (tyProc__uryidYWkntM7ddjZSyxvyQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "GetCurrentProcess");
	Dl_13277456_ = (tyProc__lLim4ugM6CVjiaTaa7eXVA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "FindFirstFileW");
	Dl_13276835_ = (tyProc__aO673xGTLLxou7P7GxoCXA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "FormatMessageW");
	Dl_13277001_ = (tyProc__im9buRnIvptJfzdASYMEbBA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "LocalFree");
	Dl_13276830_ = (tyProc__9bXer9a4ps9aSGctILcxWReVw) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "GetLastError");
	Dl_13277461_ = (tyProc__jwEWAkul5J6p6K0UfXa1tw) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "FindNextFileW");
	Dl_13277614_ = (tyProc__ofoySXaAAlxxs9bQS9a1etlg) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "FindClose");
>>>>>>> 91567dfbd88bcbd42055586b00112f98a52f5e0c
}
