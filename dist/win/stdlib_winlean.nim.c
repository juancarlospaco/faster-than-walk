...
/* Command for C compiler:
   /usr/bin/x86_64-w64-mingw32-gcc -c  -w -fmax-errors=3 -mno-ms-bitfields -DWIN32_LEAN_AND_MEAN   -I'/home/juan/.choosenim/toolchains/nim-#devel/lib' -I/home/juan/code/faster-than-walk/src -o /home/juan/code/faster-than-walk/dist/win/stdlib_winlean.nim.c.o /home/juan/code/faster-than-walk/dist/win/stdlib_winlean.nim.c */
...
tyProc__uryidYWkntM7ddjZSyxvyQ Dl_23993563_;
tyProc__lLim4ugM6CVjiaTaa7eXVA Dl_23992456_;
tyProc__aO673xGTLLxou7P7GxoCXA Dl_23991835_;
tyProc__im9buRnIvptJfzdASYMEbBA Dl_23992001_;
tyProc__9bXer9a4ps9aSGctILcxWReVw Dl_23991830_;
tyProc__jwEWAkul5J6p6K0UfXa1tw Dl_23992461_;
tyProc__ofoySXaAAlxxs9bQS9a1etlg Dl_23992614_;
...
if (!((TM__k6kyf4Co79a84IkK9blFuQVA_3 = nimLoadLibrary(((NimStringDesc*) &TM__k6kyf4Co79a84IkK9blFuQVA_5)))
	...
	Dl_23993563_ = (tyProc__uryidYWkntM7ddjZSyxvyQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "GetCurrentProcess");
	Dl_23992456_ = (tyProc__lLim4ugM6CVjiaTaa7eXVA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "FindFirstFileW");
	Dl_23991835_ = (tyProc__aO673xGTLLxou7P7GxoCXA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "FormatMessageW");
	Dl_23992001_ = (tyProc__im9buRnIvptJfzdASYMEbBA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "LocalFree");
	Dl_23991830_ = (tyProc__9bXer9a4ps9aSGctILcxWReVw) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "GetLastError");
	Dl_23992461_ = (tyProc__jwEWAkul5J6p6K0UfXa1tw) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "FindNextFileW");
	Dl_23992614_ = (tyProc__ofoySXaAAlxxs9bQS9a1etlg) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "FindClose");
}
