...
/* Command for C compiler:
   /usr/bin/x86_64-w64-mingw32-gcc -c  -w -fmax-errors=3 -mno-ms-bitfields -DWIN32_LEAN_AND_MEAN   -I/home/juan/.choosenim/toolchains/nim-1.4.0/lib -I/home/juan/code/faster-than-walk/src -o /home/juan/code/faster-than-walk/dist/win/stdlib_pathnorm.nim.c.o /home/juan/code/faster-than-walk/dist/win/stdlib_pathnorm.nim.c */
			...
			LA16_: ;
			{
				...
				nimln_(76, "pathnorm.nim");
				{
					...
					nimln_(86, "pathnorm.nim");
					{
						...
						(*result) = setLengthStr((*result), ((NI) ((NI)(TM__DfU0iuayCGwHDN1Exp9cbKg_16))));
...
appendString((*result), T64_);
	...
	nimln_(100, "pathnorm.nim");
	{
		...
		LA68_: ;
		if (!T67_) goto LA69_;
		(*result) = copyString(((NimStringDesc*) &TM__DfU0iuayCGwHDN1Exp9cbKg_19));
	}
	LA69_: ;
<<<<<<< HEAD
	popFrame();
