...
N_LIB_PRIVATE N_NOCONV(void*, allocImpl__KzdpcuLT9aef9bsiSHlIu9aFg_3)(NI size);
...
N_LIB_PRIVATE N_NIMCALL(void*, alignedAlloc0__tDURxGxuLs0hKEDbtrBxug)(NI size, NI align) {
	...
	LA3_: ;
	{
		...
		NI T6_;
		NI T7_;
		base = alloc0Impl__KzdpcuLT9aef9bsiSHlIu9aFg(((NI) ((NI)((NI)((NI)(((NI) (size)) + ((NI) (align))) - ((NI) 1)) + ((NI) 2)))));
...
N_LIB_PRIVATE N_NOCONV(void*, allocImpl__KzdpcuLT9aef9bsiSHlIu9aFg_3)(NI size) {
	void* result;
	result = (void*)0;
	result = alloc__UxtcZ3QOXKsB7mMchxUf9cg_2((&allocator__Het9ctRSeaVb4hPekZZNCJQ), size);
	return result;
}
N_LIB_PRIVATE N_NOCONV(void*, allocSharedImpl)(NI size) {
	void* result;
	result = (void*)0;
	result = allocImpl__KzdpcuLT9aef9bsiSHlIu9aFg_3(size);
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, toNimStr)(NCSTRING str, NI len) {
	...
	LA3_: ;
	{
		...
		colontmpD_ = (NI)0;
		T6_ = (void*)0;
		T6_ = alloc0Impl__KzdpcuLT9aef9bsiSHlIu9aFg(((NI) ((NI)((NI)(len + ((NI) 1)) + ((NI) 8)))));
		p = ((NimStrPayload*) (T6_));
		(*p).cap = len;
		{
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, rawNewString)(NI space) {
	...
	LA3_: ;
	{
		...
		void* T6_;
		T6_ = (void*)0;
		T6_ = alloc0Impl__KzdpcuLT9aef9bsiSHlIu9aFg(((NI) ((NI)((NI)(space + ((NI) 1)) + ((NI) 8)))));
		p = ((NimStrPayload*) (T6_));
		(*p).cap = space;
		nimZeroMem((void*)(&result), sizeof(NimStringV2));
		result.len = ((NI) 0);
...
N_LIB_PRIVATE N_NIMCALL(void*, alignedAlloc__tDURxGxuLs0hKEDbtrBxug_2)(NI size, NI align) {
	...
	LA3_: ;
	{
		...
		NI T6_;
		NI T7_;
		base = allocImpl__KzdpcuLT9aef9bsiSHlIu9aFg_3(((NI) ((NI)((NI)((NI)(((NI) (size)) + ((NI) (align))) - ((NI) 1)) + ((NI) 2)))));
		offset = (NI)(((NI) (align)) - (NI)(((NI) (ptrdiff_t) (base)) & (NI)(((NI) (align)) - ((NI) 1))));
		T6_ = (NI)0;
		T6_ = pluspercent___dgYAo7RfdUVVpvkfKDym8wsystem(((NI) (ptrdiff_t) (base)), (NI)(offset - ((NI) 2)));
		(*((NU16*) (((void*) (T6_))))) = ((NU16) (offset));
...
N_LIB_PRIVATE N_NIMCALL(void, prepareAdd)(NimStringV2* s, NI addlen) {
	{
		...
		oldP = (*s).p;
		T7_ = (void*)0;
		T7_ = alloc0Impl__KzdpcuLT9aef9bsiSHlIu9aFg(((NI) ((NI)((NI)((NI)((*s).len + addlen) + ((NI) 1)) + ((NI) 8)))));
...
N_LIB_PRIVATE N_NIMCALL(void, nimPrepareStrMutationImpl__C0YoABEefTaYbWLv9aVOzZA)(NimStringV2* s) {
	...
	oldP = (*s).p;
	T1_ = (void*)0;
	T1_ = alloc0Impl__KzdpcuLT9aef9bsiSHlIu9aFg(((NI) ((NI)((NI)((*s).len + ((NI) 1)) + ((NI) 8)))));
...
{	{
	...
	LA9_: ;
	{
		...
		void* T34_;
		{
			...
			LA30_: ;
			T32_ = (void*)0;
			T32_ = alloc0Impl__KzdpcuLT9aef9bsiSHlIu9aFg(((NI) ((NI)((NI)(b.len + ((NI) 1)) + ((NI) 8)))));
